...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{route('alternatif')}}">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{route('normalisasi')}}">
                    <i class="fas fa-fw fa-folder"></i>
    ...
    <!-- Page level plugins -->
    <script src="{{url ('AdminLTE/vendor/chart.js/Chart.min.js') }}"></script>

    <!-- Page level custom scripts -->
    <script src="{{url ('AdminLTE/js/demo/chart-area-demo.js') }}"></script>
    <script src="{{url ('AdminLTE/js/demo/chart-pie-demo.js') }}"></script>
